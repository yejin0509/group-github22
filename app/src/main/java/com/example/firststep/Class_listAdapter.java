...
public class Class_listAdapter extends RecyclerView.Adapter<Class_listAdapter.MyViewHolder> { //viewHolder 은 layout 객체에 존재하는 view를 보관하는 holder 객체
    ...
    public Class_listAdapter(Class_list questionChange, ArrayList<String> categoryList){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) { // viewHolder 생성 시에 호출
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.class_list2,parent,false);
